class LanguageLocal {
  static const Map<String,dynamic> isoLangs = {
    ...
    "pt-pt": {"name": "Portuguese (Portugal)", "nativeName": "Português"},
  ...
  static Map<String, dynamic>? getDisplayLanguage(key) {
    if (key.contains('Hans')) {
      return {'name': 'Chinese (Simplified)'};
    }
    if (key.contains('Hant')) {
      return {'name': 'Chinese (Traditional)'};
    }
